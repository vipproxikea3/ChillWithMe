    ...
    <div class="row d-flex justify-content-center mt-3">
        <form class="col-xl-6 col-lg-6 col-md-8 col-12" id="form-password" method="POST" action="/home/change-password">
            ...
            <div class="form-group row">
                <input placeholder="Mật khẩu hiện tại" id="input-current-password" type="password" class="input-current-password " 
                name="currentpassword">
                <div><span class="text-danger error-text currentpassword_error ml-4"></span></div>
            </div>

            <div class="form-group row">
                <input placeholder="Mật khẩu mới" id="input-new-password" type="password" class="input-new-password " 
                name="newpassword">
                <div><span class="text-danger error-text newpassword_error ml-4"></span></div>
            </div>

            <div class="form-group row">
                <input placeholder="Xác nhận mật khẩu" id="input-confirm-new-password" type="password" class="input-confirm-new-password"
                name="cnewpassword">
